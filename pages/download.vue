...
const downloads = {
    'android': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.13/Spixi-v0.9.13-Android.apk',
    'windows': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.13/Spixi-v0.9.13-Win.zip'
}
</script>
