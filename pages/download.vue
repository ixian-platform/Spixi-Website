...
const downloads = {
    'android': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.10/Spixi-v0.9.10-Android.apk',
    'windows': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.10/Spixi-v0.9.10-Win.zip'
}
</script>
