...
const downloads = {
    'android': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.9/Spixi-v0.9.9-Android.apk',
    'windows': 'https://github.com/ixian-platform/Spixi/releases/download/v0.9.9/Spixi-v0.9.9-Win.zip'
}
</script>
